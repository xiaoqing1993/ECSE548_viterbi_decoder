...
\title{Project Report: (8, 4, 4) Viterbi Decoder}
...
\subsubsection{Propagation Delay}
Similar to power consumption, we can compare bot the minimum and maximum propagation delay for each module located in the top level. Figure \ref{fig:delay1} and Figure \ref{fig:delay2} demonstrate the simulation results under average and maximum loading respectively, with the MUX6 module being neglected from analysis as it has the same delay as MUX2.
